<div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-3 col-6">
                <div class="d-flex flex-column mb-md-10 mb-5 mt-3 mt-md-0">
                    ...
                    <span class="fs-5 text-gray-800">{{ \Carbon\Carbon::parse($invoice->invoice_date)->format('jS M, Y') }}</span>
                </div>
            </div>
            ...
            <div class="col-md-2 col-md-6">
                <div class="d-flex flex-column mb-md-10 mb-5">
                    <label for="name" class="pb-2 fs-5 text-gray-600">Issue By:</label>
    ...
    <div class="col-xxl-4">
        <div class="bg-gray-100 rounded-15 p-md-7 p-5 h-100 mt-xxl-0 mt-5 col-xxl-9 ms-xxl-auto">
            ...
            <h6 class="mb-5">PATIENT {{ __('messages.overview') }}</h6>
            <div class="mb-6">
