...
<table width="100%">
    <tr>
        <td class="header-left">
            <div class="main-heading">{{__('messages.patient_diagnosis_test.patient_diagnosis_test')}} {{__('messages.reports')}}</div>
            <div class="invoice-number font-color-gray">{{__('messages.patient_diagnosis_test.patient_diagnosis_test')}} {{__('messages.patient_diagnosis_test.report_number')}}
                    ...
                    <td class="patient-details">
                        <table class="patient-detail-one">
                            <tr>
                                ...
                                <td>{{ $patientDiagnosisTest->patient->patientUser->full_name }}</td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold">{{ __('messages.user.email') }}:</td>
                                <td>{{ $patientDiagnosisTest->patient->patientUser->email }}</td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold">{{ __('messages.bill.cell_no') }}:</td>
                                <td>{{ !empty($patientDiagnosisTest->patient->patientUser->phone)  ? $patientDiagnosisTest->patient->patientUser->phone : 'N/A' }}</td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold">{{ __('messages.user.gender') }}:</td>
                                <td>{{ $patientDiagnosisTest->patient->patientUser->gender == 0 ? 'Male' : 'Female' }}</td>
                            </tr>
                        </table>
                    </td>
                    <td>
                        <table class="patient-detail-two">
                            <tr>
                                ...
                                <td>{{ $patientDiagnosisTest->doctor->doctorUser->full_name }}</td>
                            </tr>
                            <tr>
